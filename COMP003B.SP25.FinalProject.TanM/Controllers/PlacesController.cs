...
namespace COMP003B.SP25.FinalProject.TanM.Controllers
{
    public class PlacesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlaceId,Name,Location,Description,TerrainDifficulty")] Place place)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaceId,Name,Location,Description,TerrainDifficulty")] Place place)
        {
            if (id != place.PlaceId)
            {
                return NotFound();
